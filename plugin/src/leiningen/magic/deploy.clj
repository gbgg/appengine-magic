(ns leiningen.magic.deploy
  "deploy - a magic subtask for deploying a gae app to the server (appcfg.sh update)"
...
(defn deploy
  "upload app the the prod servers - 'lein magic :deploy'"
  [project & args]
                              ...
                              appengine-sdk (cond (nil? appengine-sdk) (if-let [from-env (System/getenv "APPENGINE_HOME")]
                                                                         ...
                                                                         (abort (str "deploy "
                                                                                          (str "no App Engine SDK specified: "
                                                                                               "set :sdk in :magic-app-config stanza of project.clj, "
